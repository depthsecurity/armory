...
class ToolTemplate(ModuleTemplate):
    ...
    def set_options(self):
        ...
        self.options.add_argument('--timeout', help="Thread timeout in seconds, default is never timeout", default='0')
        self.options.add_argument('--hard_timeout', help="Hard timeout in seconds. When this is elapsed, the thread will be kill -9'd", default='0')
