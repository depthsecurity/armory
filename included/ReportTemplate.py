...
class ReportTemplate(object):
    ...
    def set_options(self):
        ...
        self.options.add_argument('-j', '--json', help="Output as JSON", action="store_true")
        self.options.add_argument('-c', '--cmd', help="Output as Custom MarkDown", action="store_true")
        self.options.add_argument('-p', '--plain' ,help="Output as plain, with tabs", action="store_true")
