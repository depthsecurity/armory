...
class Module(ToolTemplate):
    ...
    def set_options(self):
        ...
        self.options.add_argument('-ho', '--host', help="Host to scan (service://host:port)")
        self.options.add_argument('-hw', '--host_wordlist', help="Wordlist to use for one off host")
    ...
    def get_targets(self, args):
        ...
        if args.host:
            ...
            targets.append({'target':host, 'service':service, 'port':port, 'wordlist':args.host_wordlist})
        ...
        for t in targets:
            t['output'] = os.path.join(output_path, "{}-{}.txt".format(t['target'],t['port']) )
