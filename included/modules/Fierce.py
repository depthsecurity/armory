...
class Module(ToolTemplate):
    ...
    def set_options(self):
        ...
        self.options.add_argument('--rescan', help="Force rescan of already scanned domains", action="store_true")
    ...
    def process_output(self, cmds):
        ...
        for c in cmds:
            ...
            try:
                ...
                display_error("The output file for {} was not found. If fierce timed out, but is still running, you can run this tool again with the --no_binary flag to just grab the file.".format(target))
                continue
            ...
            if "Now performing" in fierceOutput:
                ...
                display_error("Unable to process {}.  If fierce timed out, but is still running, you can run this tool again with the --no_binary flag to just grab the file.".format(output_path))
