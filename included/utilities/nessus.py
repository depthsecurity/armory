...
class NessusRequest(object):
    ...
    HEADERS = {}
    def __init__(self, username, password, host, verify=False, proxies=None, uuid=None, folder_id = None, policy_id = 23):
    ...
    def req(self, verb, uri, **kwargs):
        ...
        return func(self.HOST+uri, headers=self.HEADERS, verify=self.VERIFY, proxies=self.PROXIES, **kwargs)
    ...
    def login(self, username, password, host):
        ...
        self.HEADERS['X-API-TOKEN'] = res.text[token_location:token_location+200].split('"')[2]
    ...
    def export_file(self, job_id, output_path):
        ...
        res = json.loads(self.req('post', '/scans/{}/export'.format(job_id), data=data).text)
